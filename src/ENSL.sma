...
{	
	...
	// Register CVARs
	g_cvar_minrate = register_cvar("ensl_minrate", "20000")
	...
	g_cvar_minupdaterate = register_cvar("ensl_minupdaterate", "60")
	g_cvar_maxupdaterate = register_cvar("ensl_maxupdaterate", "102")
	...
	g_cvar_checkrates = register_cvar("ensl_checkrates", "0")
...
public func_init_cvars()
{
	...
	func_add_int_cvar("sv_minrate", 20000)
	func_add_int_cvar("sv_maxrate", 100000)
	func_add_int_cvar("sv_minupdaterate", 60)
	func_add_int_cvar("sv_maxupdaterate", 102)
	func_add_int_cvar("sv_proxies", 5)
	func_add_int_cvar("ensl_minrate", 20000)
	func_add_int_cvar("ensl_maxrate", 100000)
	func_add_int_cvar("ensl_mincmdrate", 60)
	func_add_int_cvar("ensl_maxcmdrate", 255)
	func_add_int_cvar("ensl_minupdaterate", 60)
	func_add_int_cvar("ensl_maxupdaterate", 102)
